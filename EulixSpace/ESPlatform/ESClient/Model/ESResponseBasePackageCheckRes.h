...
@class ESPackageCheckRes;



@protocol ESResponseBasePackageCheckRes
@end

@interface ESResponseBasePackageCheckRes : ESObject
...
@property(nonatomic) ESPackageCheckRes* results;
