...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"aoId", @"authKey", @"clientRegKey", @"clientUUID", @"createAt", @"_id", @"image", @"imageMd5", @"personalName", @"personalSign", @"phoneModel", @"role", @"userDomain", @"userRegKey"];
