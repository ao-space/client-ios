...
@class ESVerifyTokenResult;



@protocol ESResponseBaseVerifyTokenResult
@end

@interface ESResponseBaseVerifyTokenResult : ESObject
...
@property(nonatomic) ESVerifyTokenResult* results;
