...
@class ESAppletInfoRes;



@protocol ESResponseBaseListAppletInfoRes
@end

@interface ESResponseBaseListAppletInfoRes : ESObject
...
@property(nonatomic) NSArray<ESAppletInfoRes>* results;
