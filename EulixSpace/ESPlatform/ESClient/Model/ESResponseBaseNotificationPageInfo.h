...
@protocol ESNotificationPageInfo;
@class ESNotificationPageInfo;



@protocol ESResponseBaseNotificationPageInfo
@end

@interface ESResponseBaseNotificationPageInfo : ESObject
...
@property(nonatomic) ESNotificationPageInfo* results;
