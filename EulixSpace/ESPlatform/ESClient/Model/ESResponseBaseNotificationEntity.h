...
@class ESNotificationEntity;



@protocol ESResponseBaseNotificationEntity
@end

@interface ESResponseBaseNotificationEntity : ESObject
...
@property(nonatomic) ESNotificationEntity* results;
