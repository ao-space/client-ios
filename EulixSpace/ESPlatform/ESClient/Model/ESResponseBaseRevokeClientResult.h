...
@class ESRevokeClientResult;



@protocol ESResponseBaseRevokeClientResult
@end

@interface ESResponseBaseRevokeClientResult : ESObject
...
@property(nonatomic) ESRevokeClientResult* results;
