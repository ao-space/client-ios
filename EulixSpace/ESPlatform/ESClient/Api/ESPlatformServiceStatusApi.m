...
@interface ESPlatformServiceStatusApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ESPlatformServiceStatusApi

NSString* kESPlatformServiceStatusApiErrorDomain = @"ESPlatformServiceStatusApiErrorDomain";
NSInteger kESPlatformServiceStatusApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) spaceStatusGetWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/space/status"];
