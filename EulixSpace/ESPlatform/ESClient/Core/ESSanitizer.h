...
extern NSString * ESPercentEscapedStringFromString(NSString *string);

extern NSString * const kESApplicationJSONType;

@protocol ESSanitizer <NSObject>
...
@interface ESSanitizer : NSObject <ESSanitizer>
