#import "ESResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const ESDeserializationErrorDomainKey = @"ESDeserializationErrorDomainKey";

NSInteger const ESTypeMismatchErrorCode = 143553;

NSInteger const ESEmptyValueOccurredErrorCode = 143509;

NSInteger const ESUnknownResponseObjectErrorCode = 143528;


@interface ESResponseDeserializer ()
...
@implementation ESResponseDeserializer
...
- (id) deserialize:(id) data class:(NSString *) className error:(NSError **) error {
    ...
    if([className isEqual:@"ESStatusResult"]){
        NSLog(@"%@",jsonData);
    }
    ...
    if([jsonData isKindOfClass:[NSString class]]){
        if([jsonData containsString:@"domain rewrite timeout"]){
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:ESDeserializationErrorDomainKey code:ESTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ESDeserializationErrorDomainKey code:ESEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ESDeserializationErrorDomainKey code:ESUnknownResponseObjectErrorCode userInfo:userInfo];
}
