...
NSString * const kESApplicationJSONType = @"application/json";

NSString * ESPercentEscapedStringFromString(NSString *string) {
    static NSString * const kESCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kESCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kESCharactersGeneralDelimitersToEncode stringByAppendingString:kESCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[ESQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [ESSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[ESObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [ESSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [ESDefaultConfiguration sharedConfig].serializationTimeZone;
