 ...
 */
extern NSString *const ESResponseObjectErrorKey;


@interface ESApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<ESConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<ESResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<ESSanitizer> sanitizer;
