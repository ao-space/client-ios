...
#import "ESBasicAuthTokenProvider.h"
#import "ESLogger.h"

@interface ESDefaultConfiguration ()
...
@implementation ESDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static ESDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [ESBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
