...
typedef void (^ESGetAppletInfosCompletionBlock)(NSArray<ESAppletInfoModel *> *infoList, NSError * _Nullable error);
typedef void (^ESAppletOperateCompletionBlock)(BOOL success, ESAppletOperateType operateTyp, NSError * _Nullable error);

@interface ESAppletManager : NSObject
