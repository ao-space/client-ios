...
@implementation ESNavigationBar (ESStyle)
...
- (NSDictionary *)showStyleMap {
    return @{
        ...
        @"moreBt"  : @{ @"isTranslucent" : @"applet_more" , @"isBarkStyle" : @"applet_more", @"lightStyle" : @"applet_more" },
...
- (void)updateShowStyle {
    ...
    NSString *moreImageBtName = [self showStyleImageNameWithViewKey:@"moreBt"];
    [self.moreBt setImage:[UIImage imageNamed:moreImageBtName] forState:UIControlStateNormal];
