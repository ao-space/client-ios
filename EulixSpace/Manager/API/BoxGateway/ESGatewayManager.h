...
typedef void (^ESGatewayManageOnToken)(ESTokenItem *token, NSError *error);

@interface ESGatewayManager : NSObject
...
+ (void)call:(ESBoxItem *)activeBox request:(ESRealCallRequest *)request callback:(void (^)(id output, NSError *error))callback;
