...
@interface ESAlbumBasePageListModule :  NSObject <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, weak) UIViewController *parentVC;
@property (nonatomic, readonly) NSArray<ESAlbumModel *> *albumList;
