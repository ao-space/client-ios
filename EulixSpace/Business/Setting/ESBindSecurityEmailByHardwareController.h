...
//
//  ESBindSecurityEmailByHardwareController.h
//  EulixSpace
//
...
@interface ESBindSecurityEmailByHardwareController : ESBindSecurityEmailBySecurityCodeController<ESBoxBindViewModelDelegate>
