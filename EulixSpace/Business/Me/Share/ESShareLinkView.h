...
@class ESShareLinkView;

@protocol ESShareViewLinkDelegate <NSObject>

@optional

- (void)shareLinkView:(ESShareLinkView *)shareView didClicCancelBtn:(UIButton *)button;

- (void)shareViewShareOther:(ESShareLinkView *)shareView;

@end

@interface ESShareLinkView : UIView

@property (nonatomic, strong) NSArray<NSString*>* fileIds;

@property (nonatomic, weak) id<ESShareViewLinkDelegate> delegate;
