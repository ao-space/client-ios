...
#import <GKPhotoBrowser/GKPanGestureRecognizer.h>
...
@interface ESPhotoBrowser()<UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (instancetype)initWithPhotos:(NSArray<GKPhoto *> *)photos currentIndex:(NSInteger)currentIndex {
    if (self = [super init]) {
        ...
        self.isFullWidthForLandScape = NO;
        ...
        self.isFollowSystemRotation = YES;
    }
    return self;
}
...
- (void)setupUI {
    ...
    self.contentView = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                kTopHeight,
                                                                width,
                                                                height - 50 - kBottomHeight - kTopHeight)];
...
- (UIInterfaceOrientationMask)supportedInterfaceOrientations {
    return self.isFollowSystemRotation ? UIInterfaceOrientationMaskPortrait : UIInterfaceOrientationMaskPortrait;
}
