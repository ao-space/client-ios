...
@class ESWebBottomView;

@protocol ESWebBottomViewDelegate <NSObject>
...
@interface ESWebBottomView : UIView

@property (nonatomic, weak) id<ESWebBottomViewDelegate> delegate;

@property (nonatomic, strong) ESAppletInfoModel *fileInfo;
