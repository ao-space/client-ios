...
@interface ESDiskInitProgressPage : ESBaseTableVC <ESBoxBindViewModelDelegate>
...
@property (nonatomic, assign) ESDeviceStartupStatus status;
@property (nonatomic, readonly) ESDiskInitProgressView * progressView;
// 初始化失败的视图
@property (nonatomic, readonly) ESESDiskInitFailedView * failedView;
@end
